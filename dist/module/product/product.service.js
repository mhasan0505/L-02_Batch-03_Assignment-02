...
const SearchProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.find({ name: { $regex: /iphone/, $option: "i" } });
    return result;
});
const updateProductById = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.findByIdAndUpdate();
    return result;
});
const deleteProductById = () => __awaiter(void 0, void 0, void 0, function* () {
